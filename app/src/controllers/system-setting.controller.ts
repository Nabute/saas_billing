...
export class SystemSettingController {
    ...
    async create(
        ...
        return await this.systemSettingService.create(createSystemSettingDto, entityManager);
    }
    ...
    async findOne(@Param('id') id: string, @Req() req: any): Promise<SystemSetting> {
        const entityManager = req.transactionManager;
    ...
    async update(
        ...
        const entityManager = req.transactionManager;
        return await this.systemSettingService.update(id, updateSystemSettingDto, entityManager);
    }
