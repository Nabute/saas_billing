...
export class DataLookupService {
     ...
     */
    async createBulk(createDataLookupDtos: CreateDataLookupDto[]): Promise<DataLookup[]> {
        const lookupDataList = createDataLookupDtos.map(dto => this.lookupRepository.create(dto));
